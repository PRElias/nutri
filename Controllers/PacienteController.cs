...
namespace nutri.Controllers
{
    public class PacienteController : Controller
    {
        ...
        {
            return View(db.FindAllPacientes().Where(e => e.IsDeleted == false));
        }
        ...
        public IActionResult Upsert(Paciente paciente, [FromServices] NutriRepository db)
        {
            if (paciente.Id == 0)
            {
        ...
        public IActionResult Edit(int id, [FromServices] NutriRepository db)
        {
            Paciente paciente = db.FindOnePaciente(id);
        ...
        [HttpDelete]
        public IActionResult Delete(int id, [FromServices] NutriRepository db)
        {
            var resultado = db.DeletePaciente(id);
